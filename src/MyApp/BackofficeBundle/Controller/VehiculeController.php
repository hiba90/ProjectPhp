...
use MyApp\BackofficeBundle\Entity\Vehicule;
use MyApp\BackofficeBundle\Form\VehiculeType;
...
class VehiculeController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MyAppBackofficeBundle:Vehicule')->findAll();

        return $this->render('MyAppBackofficeBundle:Vehicule:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('MyAppBackofficeBundle:Vehicule:new.html.twig', array(
            'entity' => $entity,
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('MyAppBackofficeBundle:Vehicule')->find($id);
        ...
        return $this->render('MyAppBackofficeBundle:Vehicule:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('MyAppBackofficeBundle:Vehicule:edit.html.twig', array(
            'entity'      => $entity,
